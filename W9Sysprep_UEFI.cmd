...
:PROMPT
SET /P AREYOUSURE=You are about to prep this system for imaging with a UEFI boot. Are you sure (Y/[N])?
...
C:\Windows\System32\Sysprep\sysprep.exe /generalize /shutdown /oobe /unattend:%~dp0unattendUEFI.xml
